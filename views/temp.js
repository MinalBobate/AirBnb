        ...
        <div class="imgContainer">
            ...
            <div class="sideImages">
                <div class="sideImgDiv">
                    <img src="<%=property.propertyImages[0]%>"
                        alt="property-image2">
                </div>

                <div class="sideImgDiv rightTopImg">
                    <img src="<%=property.propertyImages[1]%>"
                        alt="property-image3">
                </div>
                <div class="sideImgDiv">
                    <img src="<%=property.propertyImages[2]%>"
                        alt="property-image4">
                </div>
                <div class="sideImgDiv rightBottomImg" style="position: relative;">
                    <img src="<%=property.propertyImages[3]%>"
                        alt="property-image5">
                    <div
    ...
    <div class="thingsToKnow mt-3 px-5">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div>Review the Host’s full cancellation policy which applies even if you cancel for illness or
